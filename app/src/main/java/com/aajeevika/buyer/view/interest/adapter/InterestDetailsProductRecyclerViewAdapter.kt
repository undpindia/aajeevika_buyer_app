...
class InterestDetailsProductRecyclerViewAdapter(val dataList:ArrayList<ProductBasicData>) : BaseRecyclerViewAdapter() {
    ...
    inner class ProductViewHolder(private val viewDataBinding: ListItemInterestsDetailsProductBinding) : BaseViewHolder(viewDataBinding) {
        override fun bindData(context: Context) {
            ...
            viewDataBinding.price = dataList[layoutPosition].price?.toInt() ?: 0
